<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Minsun's%20Github%20Profile&fontSize=50&fontColor=ffffff">
</p>
  ...
  <tbody>
    <tr>
      <td align="center" width="150px">
        <a href="https://github.com/yugwon29-lab/DreamTale_Real"><b>관통프로젝트</b></a>
      </td>
      <td>
        AI가 스토리와 그림을 생성해주는 인터랙티브 동화책 플랫폼
      </td>
      <td width="220px">
        <code>Django</code> <code>HTML</code> <code>JS</code> <code>Gemini</code> <code>Vue.js</code>
      </td>
    </tr>
  </tbody>
</table>
